...
- **Email**: conduct@sql-learning-repo.com
- **GitHub Issues**: Use the [Bug Report Template](.github/ISSUE_TEMPLATE/bug-report.md) with "Code of Conduct Violation" in the title
